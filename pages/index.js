  ...
  return (
    <>
      ...
      <Box display={{ base: "none", xl: "block" }}>
        ...
        <Box h="100vh" w="100vw" className="gold">
          <Flex
            justifyContent={"center"}
            alignItems={"center"}
            h="100%"
        ...
        >
          <Box className="sa sa--up">
            ...
            <Flex justifyContent={"center"} alignItems={"center"} h="100%">
              ...
              <Image
                src="https://images.unsplash.com/photo-1561948955-570b270e7c36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=301&q=80"
                width={"600px"}
              />
            </Flex>
            <ScrollAnimation />
